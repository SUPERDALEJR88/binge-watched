(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('util'), require('mobx'), require('mobx-state-tree'), require('react'), require('mobx-react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'util', 'mobx', 'mobx-state-tree', 'react', 'mobx-react'], factory) :
  (global = global || self, factory(global.mobxStateTreeRouter = {}, global.util, global.mobx, global.mobxStateTree, global.React, global.mobxReact));
}(this, (function (exports, util, mobx, mobxStateTree, React, mobxReact) { 'use strict';
  ...
  var View = mobxStateTree.types.model('View', {
    ...
    return {
      ...
      beforeEnter: mobxStateTree.flow( /*#__PURE__*/regenerator.mark(function _callee(params) {
      ...
      onEnter: mobxStateTree.flow( /*#__PURE__*/regenerator.mark(function _callee2(params) {
      ...
      beforeExit: mobxStateTree.flow( /*#__PURE__*/regenerator.mark(function _callee3(params) {
      ...
      onExit: mobxStateTree.flow( /*#__PURE__*/regenerator.mark(function _callee4(params) {
  ...
  var RouterStore = mobxStateTree.types.model('RouterStore', {
    ...
    return {
      ...
      setView: mobxStateTree.flow( /*#__PURE__*/regenerator.mark(function _callee(view, params) {
